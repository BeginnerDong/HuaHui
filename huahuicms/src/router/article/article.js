...
export default {
	...
	children: [{
		...
		},
		{
			...
			name: '首页经典案例',
			icon: 'reorder',
			id: '3-/article/article/homeCase',
			child_button: [{
					name: '添加',
					id: '/article/article/homeCase-添加'
				},
				{
					name: '编辑',
					id: '/article/article/homeCase-编辑'
				},
				{
					name: '删除选中',
					id: '/article/article/homeCase-删除选中'
				},
			],
			component: Article.HomeCase
		},
		{
			path: 'articles',
			name: '首页轮播案例',
